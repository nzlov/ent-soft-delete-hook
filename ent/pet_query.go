...
func (pgb *PetGroupBy) Scan(ctx context.Context, v any) error {
	...
	return scanWithInterceptors[*PetGroupBy](ctx, pgb, pgb.build.inters, v)
}

func (pgb *PetGroupBy) sqlScan(ctx context.Context, v any) error {
	selector := pgb.sqlQuery(ctx)
	if err := selector.Err(); err != nil {
		return err
	}
	rows := &sql.Rows{}
...
func (pgb *PetGroupBy) sqlQuery(ctx context.Context) *sql.Selector {
	selector := pgb.build.sqlQuery(ctx).Select()
	...
	return selector.GroupBy(selector.Columns(*pgb.flds...)...)
}
...
func (ps *PetSelect) Scan(ctx context.Context, v any) error {
	...
	return scanWithInterceptors[*PetSelect](ctx, ps, ps.inters, v)
}

func (ps *PetSelect) sqlScan(ctx context.Context, v any) error {
	selector := ps.PetQuery.sqlQuery(ctx)
