...
// SetDeletedTime sets the "deleted_time" field.
func (m *PetMutation) SetDeletedTime(t time.Time) {
	m.deleted_time = &t
}

// DeletedTime returns the value of the "deleted_time" field in the mutation.
func (m *PetMutation) DeletedTime() (r time.Time, exists bool) {
	v := m.deleted_time
	if v == nil {
		return
	}
...
// OldDeletedTime returns the old "deleted_time" field's value of the Pet entity.
// If the Pet object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *PetMutation) OldDeletedTime(ctx context.Context) (v time.Time, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldDeletedTime is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// ClearDeletedTime clears the value of the "deleted_time" field.
func (m *PetMutation) ClearDeletedTime() {
	m.deleted_time = nil
	m.clearedFields[pet.FieldDeletedTime] = struct{}{}
}

// DeletedTimeCleared returns if the "deleted_time" field was cleared in this mutation.
func (m *PetMutation) DeletedTimeCleared() bool {
	_, ok := m.clearedFields[pet.FieldDeletedTime]
	return ok
}

// ResetDeletedTime resets all changes to the "deleted_time" field.
func (m *PetMutation) ResetDeletedTime() {
	m.deleted_time = nil
	delete(m.clearedFields, pet.FieldDeletedTime)
}
...
func (m *PetMutation) Fields() []string {
	fields := make([]string, 0, 2)
	if m.deleted_time != nil {
		fields = append(fields, pet.FieldDeletedTime)
	}
	if m.name != nil {
...
func (m *PetMutation) ClearedFields() []string {
	var fields []string
	if m.FieldCleared(pet.FieldDeletedTime) {
		fields = append(fields, pet.FieldDeletedTime)
	}
	return fields
}
